...
export class SybaseDialect implements DialectContract {
  public readonly name = 'sybase'
  ...
  public getAdvisoryLock(): Promise<boolean> {
    throw new Error(
      'Support for advisory locks is not implemented for sybase. Create a PR to add the feature'
    )
  }
