...
const QueryBuilder_1 = require("../../src/Orm/Relations/HasMany/QueryBuilder");
const test_helpers_1 = require("../../test-helpers");
let db;
let app;
let BaseModel;
japa_1.default.group('Model | HasMany | Options', (group) => {
    group.before(async () => {
    ...
    (0, japa_1.default)('raise error when localKey is missing', (assert) => {
        ...
        try {
            ...
            assert.equal(message, 'E_MISSING_MODEL_ATTRIBUTE: "User.posts" expects "id" to exist on "User" model, but is missing');
        }
    });
    (0, japa_1.default)('raise error when foreignKey is missing', (assert) => {
        ...
        try {
            ...
            assert.equal(message, 'E_MISSING_MODEL_ATTRIBUTE: "User.posts" expects "userId" to exist on "Post" model, but is missing');
        }
    });
    ...
    (0, japa_1.default)('use custom defined primary key', (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
        ...
        __decorate([
            (0, Decorators_1.hasMany)(() => Post, { localKey: 'uid' }),
            __metadata("design:type", Object)
        ], User.prototype, "posts", void 0);
        User.boot();
        User.$getRelation('posts').boot();
    ...
    (0, japa_1.default)('use pre defined foreign key', (assert) => {
        ...
        __decorate([
            (0, Decorators_1.hasMany)(() => Post, { foreignKey: 'userUid' }),
            __metadata("design:type", Object)
        ], User.prototype, "posts", void 0);
        User.boot();
        User.$getRelation('posts').boot();
...
japa_1.default.group('Model | HasMany | Set Relations', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
...
japa_1.default.group('Model | HasMany | bulk operations', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
    ...
    (0, japa_1.default)('generate correct sql with additional constraints', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
    ...
    (0, japa_1.default)('paginate with additional constraints using related query builder', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
...
japa_1.default.group('Model | HasMany | aggregates', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
...
japa_1.default.group('Model | HasMany | preload', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
    ...
    (0, japa_1.default)('set relationship property value to empty array when no related rows have been found', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
...
japa_1.default.group('Model | HasMany | withCount', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
    ...
    (0, japa_1.default)('get count of self relationship', async (assert) => {
        ...
        __decorate([
            (0, Decorators_1.hasMany)(() => User, { foreignKey: 'parentId' }),
            __metadata("design:type", Object)
        ], User.prototype, "parents", void 0);
        User.boot();
        User.$getRelation('parents').boot();
    ...
    (0, japa_1.default)('get count of a nested relationship', async (assert) => {
        class Comment extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "id", {
    ...
    (0, japa_1.default)('set count directly on the model when defined as a property', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
        ...
        class User extends BaseModel {
            constructor() {
                ...
                Object.defineProperty(this, "postsCount", {
                    enumerable: true,
                    configurable: true,
                    writable: true,
                    value: 0
    ...
    (0, japa_1.default)('do not set count directly on the model when defined as a getter', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
    ...
    (0, japa_1.default)('lazy load related rows count', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
...
japa_1.default.group('Model | HasMany | has', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
    ...
    (0, japa_1.default)('merge query existing bindings with the count query', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
    ...
    (0, japa_1.default)('define or clause in existance query', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
    ...
    (0, japa_1.default)('define not existance query', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
    ...
    (0, japa_1.default)('define or not existance query', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
...
japa_1.default.group('Model | HasMany | whereHas', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
    ...
    (0, japa_1.default)('define custom aggregates', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
    ...
    (0, japa_1.default)('define or clause', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
    ...
    (0, japa_1.default)('define not clause', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
    ...
    (0, japa_1.default)('define or not clause', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
...
if (process.env.DB !== 'mysql_legacy') {
    japa_1.default.group('Model | HasMany | Group Limit', (group) => {
        group.before(async () => {
            app = await (0, test_helpers_1.setupApplication)();
            db = (0, test_helpers_1.getDb)(app);
            BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
        ...
        (0, japa_1.default)('apply group limit with additional constraints', async (assert) => {
            class Post extends BaseModel {
                constructor() {
                    super(...arguments);
                    Object.defineProperty(this, "userId", {
        ...
        (0, japa_1.default)('preload with group limit', async (assert) => {
            class Comment extends BaseModel {
                constructor() {
                    super(...arguments);
                    Object.defineProperty(this, "id", {
        ...
        (0, japa_1.default)('pass sideloaded data after applying group limit', async (assert) => {
            class Comment extends BaseModel {
                constructor() {
                    super(...arguments);
                    Object.defineProperty(this, "id", {
...
japa_1.default.group('Model | HasMany | save', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
...
japa_1.default.group('Model | HasMany | saveMany', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
    ...
    (0, japa_1.default)('save many related instances', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "id", {
    ...
    (0, japa_1.default)('wrap save many calls inside transaction', async (assert) => {
        assert.plan(6);
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
    ...
    (0, japa_1.default)('use parent model transaction when exists', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "id", {
...
japa_1.default.group('Model | HasMany | create', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
...
japa_1.default.group('Model | HasMany | createMany', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
    ...
    (0, japa_1.default)('create many related instances', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "id", {
    ...
    (0, japa_1.default)('wrap create many calls inside transaction', async (assert) => {
        assert.plan(4);
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
    ...
    (0, japa_1.default)('use parent model transaction when already exists', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "id", {
...
japa_1.default.group('Model | HasMany | firstOrCreate', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
    ...
    (0, japa_1.default)('return existing instance vs creating one', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "id", {
...
japa_1.default.group('Model | HasMany | updateOrCreate', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
    ...
    (0, japa_1.default)('update existing instance vs creating one', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "id", {
...
japa_1.default.group('Model | HasMany | fetchOrCreateMany', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
    ...
    (0, japa_1.default)("create related instance when there aren't any existing row", async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "id", {
...
japa_1.default.group('Model | HasMany | paginate', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
    ...
    (0, japa_1.default)('paginate using related model query builder instance', async (assert) => {
        ...
        await db.table('posts').multiInsert((0, test_helpers_1.getPosts)(18, userId));
        const user = await User.find(1);
...
japa_1.default.group('Model | HasMany | clone', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
    ...
    (0, japa_1.default)('clone related model query builder', async (assert) => {
        ...
        assert.instanceOf(clonedQuery, QueryBuilder_1.HasManyQueryBuilder);
    });
});
japa_1.default.group('Model | HasMany | scopes', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
...
japa_1.default.group('Model | HasMany | onQuery', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
    ...
    (0, japa_1.default)('invoke onQuery method on related query', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
    ...
    (0, japa_1.default)('do not invoke onQuery method on related query subqueries', async (assert) => {
        class Post extends BaseModel {
            constructor() {
                super(...arguments);
                Object.defineProperty(this, "userId", {
...
japa_1.default.group('Model | HasMany | delete', (group) => {
    group.before(async () => {
        app = await (0, test_helpers_1.setupApplication)();
        db = (0, test_helpers_1.getDb)(app);
        BaseModel = (0, test_helpers_1.getBaseModel)((0, test_helpers_1.ormAdapter)(db), app);
